...
# read coverages
cov <- read_tsv("St3_anammox-GENE-COVERAGES.txt", show_col_types = FALSE)

# read detection
det <- read_tsv("St3_anammox-GENE-DETECTION.txt", show_col_types = FALSE)
...
functions_ko_target <- functions %>%
  ...
  dplyr::filter(accession %in% c("K00368", "K15864", "K20932", "K20933",
                                 "K20934", "K20935")) %>%
...
write_tsv(final_table, "St3_anammox_final_table.tsv")
```
