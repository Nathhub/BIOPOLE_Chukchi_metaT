...
ggplot(plot_df, aes(x = amoA, y = nirK, color = station, label = sample)) +
  geom_point(size = 3) +
  geom_text(nudge_y = 0.15, size = 3, show.legend = FALSE) +
  geom_smooth(method = "lm", se = FALSE, linewidth = 0.8, color = "black") +
  labs(
    x = "Normalized coverage of amoA",
    y = "Normalized coverage of nirK",
    title = "Relationship between amoA and nirK normalized coverage"
  ) +
