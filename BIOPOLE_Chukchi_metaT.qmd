...
According to this paper: <https://doi.org/10.1080/19490976.2024.2323235>, the best way to extract taxonomy from metaT reads is using the Kraken 2/Bracken approach.
...
# 3) Use it to download sets of MAGs
# Example: download all MAG FASTA files
...
```{bash}
echo -e "name\tcontig_db_path" > external_genomes.txt
for db in *.db; do
    name="${db%.db}"
